...
This is an example application showcasing how to run Golang on CircleCI 2.0.

You can follow along with this project by reading the document => https://circleci.com/docs/2.0/language-go/
